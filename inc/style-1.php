...
function osteo_timeline_style_one_shortcode( $atts ) {
    ob_start();
    ...
    ?>
        ...
        <style>
            ...
            .osteo-timeline-style-1 .timeline-dot {
                background-color: <?php echo esc_attr( $settings['osteo_timeline_line_dot'] ); ?>!important;
            }
...
add_shortcode( 'osteo_timeline_style_one', 'osteo_timeline_style_one_shortcode' );