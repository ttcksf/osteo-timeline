...
function osteo_timeline_style_nine_shortcode( $atts) {
...
if ( $items ) {
		...
		<div class="osteo-timeline-style-9 timeline">
                                ...
                                <?php
                                    if ( 'yes' === $item['osteo_timeline_heading_switch'] ) {
                                        ?>
                                            ...
                                            <style>
                                                .osteo-timeline-style-9 .timeline__content h2:hover {
...
add_shortcode( 'osteo_timeline_style_nine', 'osteo_timeline_style_nine_shortcode' );