...
function osteo_timeline_style_eight_shortcode( $atts) {
    ...
    $settings = shortcode_atts(
        array(
            ...
            'osteo_timeline_nav_bg'                     => '',
            'osteo_timeline_nav_bg_hover'               => '',
            'osteo_timeline_line_dot'                   => '',
            'osteo_timeline_line_color'                 => '',
            'osteo_image_size'                          => '',
        ),
        $atts,
        'osteo_timeline_style_eight'
    );
...
if ( $items ) {
		...
		<div class="osteo-timeline-style-8 timeline">
                                ...
                                <?php
                                    if ( 'yes' === $item['osteo_timeline_heading_switch'] ) {
                                        ?>
                                            ...
                                            <style>
                                                .osteo-timeline-style-8 .timeline__content h2:hover {
...
add_shortcode( 'osteo_timeline_style_eight', 'osteo_timeline_style_eight_shortcode' );